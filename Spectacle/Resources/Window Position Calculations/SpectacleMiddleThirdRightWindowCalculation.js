windowPositionCalculationRegistry.registerWindowPositionCalculationWithAction(function (windowRect, visibleFrameOfSourceScreen, visibleFrameOfDestinationScreen) {
    ...
    calculatedWindowRect.y = visibleFrameOfDestinationScreen.y + Math.floor(visibleFrameOfDestinationScreen.height / 3.0) + (visibleFrameOfDestinationScreen.height % 2.0);
...
}, "SpectacleWindowActionMiddleThirdRight");