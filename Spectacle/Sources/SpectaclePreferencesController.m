...
- (void)windowDidLoad
{
  ...
  _shortcutRecorders = @{
                         ...
                         @"MoveToUpperThirdRight": _moveToUpperThirdRightShortcutRecorder,
                         @"MoveToMiddleThirdRight": _moveToMiddleThirdRightShortcutRecorder,
                         @"MoveToLowerThirdRight": _moveToLowerThirdRightShortcutRecorder,
                         @"MoveToUpperThirdLeft": _moveToUpperThirdLeftShortcutRecorder,
                         @"MoveToMiddleThirdLeft": _moveToMiddleThirdLeftShortcutRecorder,
                         @"MoveToLowerThirdLeft": _moveToLowerThirdLeftShortcutRecorder,
